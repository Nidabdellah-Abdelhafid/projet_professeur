        ...
        <div class="col-md-7 border-right">
            <div class="p-3 py-5">
                ...
                -->
                    ...
                    <div class="col-md-12"><label  class="labels">Dossier_scientifique   :   </label><div class="alert alert-primary text-dark" role="alert"><a href="/storage/{{$professeur->Dossier_scientifique}}" class="link-success text-dark"  download>Download Dossier_scientifique</a><hr><b class="text-danger">{{$professeur->etat_ds}}</b></div></div>
                    <div class="col-md-12"><label  class="labels">Dossier_Pedagogique    :   </label><div class="alert alert-primary text-dark" role="alert"><a href="/storage/{{$professeur->Dossier_Pedagogique}}" class="link-success text-dark" download>Download Dossier_Pedagogique</a><hr><b class="text-danger">{{$professeur->etat_dp}}</b></div></div>
                    <div class="col-md-12"><label  class="labels">Dossier_administratif  :   </label><div class="alert alert-primary text-dark" role="alert"><a href="/storage/{{$professeur->Dossier_administratif}}" class="link-success text-dark" download>Download Dossier_administratif</a><hr><b class="text-danger">{{$professeur->etat_da}}</b></div></div>
